...
- [x] **Health Connect Session Export**: Write completed walking sessions to Health Connect; do not write heart-rate records.
...
- [ ] **Energy Calculation**: Replace the current estimate with a more precise Kcal calculation based on weight, speed, HR, and active time.
