...
- [x] **Encrypted KS Characteristic Families**: Added live C2 service-dump support for the `24e252...` and property-verified `5833ff03` read / `5833ff02` write encrypted KS characteristic families.
