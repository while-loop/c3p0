...
- [x] **Responsive Speed Commands**: Removed per-speed FTMS control requests, reduced speed-command spacing, and coalesced rapid manual speed taps to the latest target.
